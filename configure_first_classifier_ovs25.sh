...
#ovs-ofctl -O Openflow13 add-flow br-int "table=11, nsi=254,nsp=$nsp_dec,in_port=6 actions=load:0x1->NXM_NX_REG0[], move:NXM_NX_NSH_C2[]->NXM_NX_TUN_ID[0..31], resubmit($SF_port,1)"
#ovs-ofctl -O Openflow13 add-flow br-int "table=1, nsi=254,nsp=$nsp_dec,reg0=0x1,in_port=$SF_port actions=pop_nsh,goto_table:21"

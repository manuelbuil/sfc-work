...
ovs-ofctl -O Openflow13 add-flow br-int "table=11,tcp,reg0=0x1,tp_dst=80,priority=5 actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_NSH_C2[],set_field:0xc0a80022->nshc1,set_field:$nsp->nsp,set_field:255->nsi,load:0xc0a80003->NXM_NX_TUN_IPV4_DST[],load:0x97->NXM_NX_TUN_ID[0..31],resubmit($output_port,0)"
